  ...
  const addAnimationStyles = () => {
    ...
    if (!document.getElementById(styleId)) {
      ...
      style.textContent = `
        ...
        .vine-hanging-button-simple:hover .icon-1 {
          animation: slay-1 3s cubic-bezier(0.52, 0, 0.58, 1) infinite !important;
        }
        .vine-hanging-button-simple:hover .icon-2 {
          animation: slay-2 3s cubic-bezier(0.52, 0, 0.58, 1) 1s infinite !important;
        }
        .vine-hanging-button-simple:hover .icon-3 {
          animation: slay-3 2s cubic-bezier(0.52, 0, 0.58, 1) 1s infinite !important;
        }
      `;
  ...
  return (
    <div className={`vine-hanging-container ${className}`}>
      <button
        ...
        onMouseEnter={(e) => {
          if (!disabled) {
            e.currentTarget.style.border = '1px solid #f3b182';
            e.currentTarget.style.background = 'linear-gradient(85deg, #fec195, #fcc196, #fabd92, #fac097, #fac39c)';
            e.currentTarget.style.animation = 'wind 2s ease-in-out infinite';
          }
        }}
        onMouseLeave={(e) => {
          if (!disabled) {
            e.currentTarget.style.border = '1px solid #fec195';
            e.currentTarget.style.background = '#f0e644';
            e.currentTarget.style.animation = 'none';
          }
        }}
      >
        {/* Hojas exactas del HTML que me pasaste */}
        <div 
          className="icon-1"
          style={{
            position: 'absolute',
        ...
        >
          <svg
            ...
            xmlSpace="preserve"
            version="1.1"
            style={{shapeRendering:'geometricPrecision' as const, textRendering:'geometricPrecision' as const, imageRendering:'optimizeQuality' as any, fillRule:'evenodd' as const, clipRule:'evenodd' as const}}
